...
let me = {
	...
	age: 26,
	greeter() {
		return `Hello! My name is ${this.firstName} and I live in ${this.stage}`;
	} 
}
...
// Code here
let bigOrSmall = (arr) => arr.map(num => num <= 100 ? "small" : "big");
...
//Code Here
let arrayReverser = (arr) => arr.sort((a, b) => b - a);
...
// Code Here
let filtered = myNumbers.filter(num => num > 100 ? num : null);
