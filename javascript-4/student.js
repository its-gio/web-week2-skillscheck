...
// CODE HERE
let faveColors = ["purple", "blue", "grey"]
...
let me = {
  firstName: "Gio",
  superHeroName: "Mr. Buttons",
  homeTown: "Los Angeles",
  superPowers: ["Type in passwords and usernames on the first try", "Never lose my keys or wallet", "Convinently forget birthdays"],
  superPowerXP() {
...
// CODE HERE
let setColor = (arr) => {
  arr.length > 3 ? arr.splice(3) : null;
  for (let i = 0; i < arr.length; i++) {
    arr[i].includes("blue") ? arr[i] = "#4D4DFF" : null
  }
...
// CODE HERE
let setPowers = (arr) => arr.forEach(a => createLi(a));
